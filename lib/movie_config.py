...
default_standard_package = ['EST SINGLE TITLE', 'SVOD', 'RENTAL', 'CATCHUP VOD', 'CATCHUP EPISODE', 'SVOD EPISODE', 'DPL SVOD', 'DPL CATCHUP', 'DPL SVOD EPISODE', 'DPL CATCHUP EPISODE', 'SECONDARY']
...
default_file_list = ['HDR_MOVIE.ts', 'HD_MOVIE.ts', '4K_SDR_MOVIE.ts', 'FinestHours_Trailer.ts', 'SD_2_min.ts', 'DPL_VIDEO_FILE.ts']
...
default_content_marker = 'false'
default_asset_runtime = '0:10:00'
default_movie_genre = '6:4'
default_episode_genre = '3:4'
