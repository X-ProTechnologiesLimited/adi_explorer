...
def load_default_media():
    ...
    dpl_image_4 = MEDIA_LIBRARY(filename='DPL_PRMW.jpg', checksum='e686dbbfd1e11ad36d851e6c79c00517', image_group='DPL')
    dpl_image_5 = MEDIA_LIBRARY(filename='DPL_PRSW.jpg', checksum='307e7a7482a7c11bb4dbc15c0958cd34', image_group='DPL')
    dpl_image_6 = MEDIA_LIBRARY(filename='DPL_THUM.jpg', checksum='d358bb394e2e7a11912305e29f16c3dd', image_group='DPL')
    standard_image_1 = MEDIA_LIBRARY(filename='FinestHours_182x98.jpg', checksum='e9e23717c0b20f6af34ffbbf6b83add2', image_group='FinestHours')
    standard_image_2 = MEDIA_LIBRARY(filename='FinestHours_182x243.jpg', checksum='43a1883f263a9bbae1b5944f24645430', image_group='FinestHours')
    standard_image_3 = MEDIA_LIBRARY(filename='FinestHours_262x349.jpg', checksum='300343d46b52bbe7b191d9055d12b364', image_group='FinestHours')
    standard_image_4 = MEDIA_LIBRARY(filename='FinestHours_456x257.jpg', checksum='3396a3ff9fc6e09ae94068011556d0e5', image_group='FinestHours')
    ...
    default_config = MEDIA_DEFAULT(default_video_path='Providers/BSS/Content/Distribution/TestFiles/',
                                   ...
                                   standard_image_file_prefix='FinestHours',
                                   dpl_image_file_prefix='DPL')
