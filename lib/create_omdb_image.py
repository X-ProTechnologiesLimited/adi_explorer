...
def omdb_image_create(title):
    ...
    with open(IMAGE_FETCH_DIRECTORY+'OMDB_base.jpg', 'r+b') as f:
        with Image.open(f) as image:
            ...
            create_tar.add_supporting_files_to_db(filename_182x98, checksum)
            ...
            create_tar.add_supporting_files_to_db(filename_182x243, checksum)
            ...
            create_tar.add_supporting_files_to_db(filename_800x600, checksum)
            ...
            create_tar.add_supporting_files_to_db(filename_1920x1080, checksum)
            ...
            create_tar.add_supporting_files_to_db(filename_262x349, checksum)
            ...
            create_tar.add_supporting_files_to_db(filename_456x257, checksum)
