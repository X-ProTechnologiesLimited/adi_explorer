...
def create_po(order_type, assetId):
    if order_type == 'Digital Only':
        ...
        new_purchase_option_dig = EST_PO(assetId=assetId + '01', poption_Id=assetId + '01', poption_media_type='1',
                                         poption_media_filter='4', uk_std_price=movie_config.uk_std_price,
                                         uk_vip_price=movie_config.uk_vip_price, il_std_price=movie_config.il_std_price,
                                         il_vip_price=movie_config.il_vip_price)

        new_purchase_option_dvd = EST_PO(assetId=assetId + '01', poption_Id=assetId + '02', poption_media_type='2',
        ...
        new_purchase_option_blu = EST_PO(assetId=assetId + '01', poption_Id=assetId + '03', poption_media_type='3',
